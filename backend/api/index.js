console.log("🔍 [INIT] Starting backend serverless function handler (backend/api/index.js)...");
...
let appHandler;
try {
  console.log("⏳ [INIT] Importing ../index.js...");
  const backend = await import("../index.js");
  appHandler = backend.default;
  console.log("✅ [INIT] ../index.js imported successfully!");
} catch (error) {
...
export default function handler(req, res) {
  console.log(`📡 [BACKEND-API] ${req.method} ${req.url} - Origin: ${req.headers.origin || "Direct Browser"}`);
